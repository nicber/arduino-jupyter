...
//
// El signo y el filtro arrancan apagados: un banco de identificación no los toca,
// porque un filtro acá se confunde con la planta que se mide y el signo se elige
// del lado de la computadora igual que el del ángulo.
